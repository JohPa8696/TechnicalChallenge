...
# App service in First region for HA. eg Central US
locals {
  app_services = {
...
# App service in Second region for HA. eg East US
...
# resource "azurerm_monitor_autoscale_setting" "gtd_app_service_stamp_1_autoscale" {
# }